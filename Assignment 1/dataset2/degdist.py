...
plot_degree_dist(nx.read_edgelist('/home/sahil/Downloads/2nd sem/assignments/wsc/dataset2/p2p-Gnutella04.txt'))
...
plt.title("Degree distribution of p2p-Gnutella04  ")
